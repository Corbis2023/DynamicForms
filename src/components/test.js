                ...
                children: (
                  <>
                    ...
                    {editingField?.type === 'dropdown' && (
                      <>
                        <Form.Item name="multiSelect" label="MultiSelect" valuePropName="checked">
                          <Switch />
                        </Form.Item>
                    ...
                    {editingField?.type === 'number' && (
                      <>
                        ...
                        <Form.Item name="showPercentage" label="Show Percentage" valuePropName="checked">
                          <Switch />
                        </Form.Item>
                        <Form.Item name="heightConversion" label="Height Conversion" valuePropName="checked">
                          <Switch />
                        </Form.Item>
                      </>
                    )}

                    {/* MultiSelect field specific configurations */}
                   {editingField?.type === 'multiselect' && (
                    <Form.Item name="selectAll" label="Enable Select All" valuePropName="checked">
                       <Switch />
                      </Form.Item>
                    )}

                    {/* Checkbox field specific configurations */}
                    ...
                    {/* Radio field specific configurations */}
                ...
                children: (
                  <>
                    <Row gutter={16}>
                      ...
                      <Col span={12}>
                        <Form.Item name="valueColor" label="Value Color">
                          <ColorPicker showText />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={12}>
                        <Form.Item name="labelFontSize" label="Label Font Size (px)">
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={8}>
                        <Form.Item name="boxShadow" label="Box Shadow">
